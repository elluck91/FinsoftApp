                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="text" class="form-control" name="id" value="Autogenerated" disabled>
                                                </div>
                                            </div>                                            
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" name="birthDate" value="yyyy-MM-dd">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Hire Date</label>
                                                    <input type="date" class="form-control" name="hireDate" value="yyyy-MM-dd">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
